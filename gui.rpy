...
define gui.main_menu_background = "bg_start"
define gui.game_menu_background = "bg_start"

define config.main_menu_music = "<from 5 loop 5>preambule.opus"
define config.game_menu_music = "<from 5 loop 5>preambule.opus"
